...
""" print("____________________________________")
    print("Enemy HP",bcolors.FAIL,enemy.get_hp(),"/",enemy.get_max_hp(),bcolors.ENDC)"""

# print("Your HP", bcolors.OKGREEN, player.get_hp(), "/", player.get_max_hp(), bcolors.ENDC)
 # print("Your MP", bcolors.OKBLUE, player.get_mp(), "/",player.get_max_mp(), bcolors.ENDC,"\n")
...
"""elif player.get_hp() == 0:
        print( bcolors.FAIL, "Your enemy has defeated you! You lost!", bcolors.ENDC)
        running = False"""
...
# dmg = player.generate_spell_damage(0)
print('DAMAGE IS ',dmg)
print('Player REMAINING LIFE ',player.take_damage(dmg))"""